        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="my-2">Médicos</h2>
                        </div>
                        <div class="col-md-6 text-left text-md-right pb-2 pb-md-0">
                            <a href="{{ route('medicos.createForm') }}" class="btn btn-success px-4">
                        ...
                        <tbody>
                            @foreach ($medicos as $medico)
                                <tr>
                                    ...
                                    <td>{{ $medico['Nombres_Medico'] }}</td>
                                    <td>{{ $medico['Apellidos_Medico'] }}</td>
                                    <td>{{ $medico['Telefono'] }}</td>
                                    <th>
                                        <a href="{{ route('medicos.read', $medico['Id_Medico']) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#medico-{{ $medico['Id_Medico'] }}" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                            <i class="fas fa-trash-alt"></i>
                                        </button>
                                        {{-- <a href="{{ route('descargarPDF', $medico['Id_Medico']) }}" class="btn btn-primary" target="_blanck" data-toggle="tooltip" data-placement="top" title="Ficha">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="medico-{{ $medico['Id_Medico'] }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <form action="{{ route('medicos.delete', $medico['Id_Medico']) }}" method="post">
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    ¿Esta seguro que desea eliminar al médico
                                                    <b>{{ $medico['Nombres_Medico'] }} {{ $medico['Apellidos_Medico'] }}</b>?
                                                </div>
