        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12 mb-3">
                    ...
                    <form action="{{ route('paciente.cd4cargaviral.actualizar', [$id, $no]) }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha" name="fecha" value="{{ $cd4cargaviral['Fecha_CD4CV'] }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cd4" name="cd4" value="{{ $cd4cargaviral['CD4'] }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cargaviral" name="cargaviral" value="{{ $cd4cargaviral['Carga_Viral'] }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="esquema" name="esquema" value="{{ $cd4cargaviral['Esquema'] }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="observaciones" name="observaciones" value="{{ $cd4cargaviral['Observaciones'] }}">
                                </div>
                            </div>
