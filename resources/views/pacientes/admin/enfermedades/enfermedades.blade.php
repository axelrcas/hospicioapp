                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('paciente.enfermedades.nuevo', $id) }}" class="btn btn-success px-3">
                                Nuevo Enfermedad Oportunista
                            </a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($enfermedades as $enfermedad)
                                <tr>
                                    <td>{{ $enfermedad['Enfermedades_Oportunistas'] }}</td>
                                    <td>{{ $enfermedad['Toma_Medicamento'] }}</td>
                                    <td>{{ $enfermedad['Fecha_Inicio_EO'] }}</td>
                                    <td>{{ $enfermedad['Fecha_Mejora_EO'] }}</td>
                                    <th>
                                        <a href="{{ route('paciente.enfermedades.leer', [$id, $enfermedad['Id_EO']]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#borrar-{{ $enfermedad['Id_EO'] }}" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="borrar-{{ $enfermedad['Id_EO'] }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <form action="{{ route('paciente.enfermedades.borrar', [$id, $enfermedad['Id_EO']]) }}" method="post">
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span class="d-block"><b>Código: </b>{{ $enfermedad['Id_EO'] }}</span>
                                                </div>
