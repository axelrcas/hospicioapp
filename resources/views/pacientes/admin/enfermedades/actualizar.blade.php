        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12 mb-3">
                    ...
                    <form action="{{ route('paciente.enfermedades.actualizar', [$id, $no]) }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-md-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="enfermedades" name="enfermedades" value="{{ $enfermedad['Enfermedades_Oportunistas'] }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" id="medicamentos" name="medicamentos" required>
                                        <option value="{{ $enfermedad['Toma_Medicamento'] }}">{{ $enfermedad['Toma_Medicamento'] }}</option>
                                        @if ( $enfermedad['Toma_Medicamento'] == "Si" )
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha" name="fecha" value="{{ $enfermedad['Fecha_Inicio_EO'] }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="mejora" name="mejora" value="{{ $enfermedad['Fecha_Mejora_EO'] }}">
                                </div>
                            </div>
