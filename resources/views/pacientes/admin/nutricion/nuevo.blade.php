        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12 mb-3">
                    ...
                    <form action="{{ route('paciente.nutricion.crear', $id) }}" method="post">
                        @csrf

                        <input type="hidden" name="idpaciente" id="idpaciente" value="{{ $infoPrincipal['Id_Paciente'] }}">
                                ...
                                <div class="form-group mt-3 ml-5">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" id="tercero" name="tercero">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group mt-3 ml-4">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" id="segundo" name="segundo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group mt-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" id="primero" name="primero">
                                        </div>
                                    </div>
                                </div>
                            </div>
