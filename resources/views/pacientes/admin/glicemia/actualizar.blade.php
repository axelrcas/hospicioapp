        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12 mb-3">
                    ...
                    <form action="{{ route('paciente.glicemia.actualizar', [$id, $glicemia['Id_Glicemia']]) }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha" name="fecha" value="{{ $glicemia['Fecha_Glicemia'] }}" required>
                                </div>
                            </div>

                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label for="horapre" class="ml-2">Hora Pre</label>
                                    <input type="time" class="form-control" id="horapre" name="horapre" value="{{ $glicemia['Hora_Pre'] }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group mt-3 ml-5">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <label for="pre" class="mt-2 mr-2">Pre:</label>
                                            <input type="checkbox" id="pre" name="pre" @if ( $glicemia['Pre'] == "true" ) checked @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label for="horapos" class="ml-2">Hora Pos</label>
                                    <input type="time" class="form-control" id="horapos" name="horapos" value="{{ $glicemia['Hora_Pos'] }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group mt-3 ml-5">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <label for="pos" class="mt-2 mr-2">Pos:</label>
                                            <input type="checkbox" id="pos" name="pos" @if ( $glicemia['Pos'] == "true" ) checked @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
