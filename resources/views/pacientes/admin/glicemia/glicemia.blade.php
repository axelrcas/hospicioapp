            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('paciente.glicemia.nuevo', $id) }}" class="btn btn-success px-3">
                                Ingresar Nuevo Control
                            </a>
                            <a href="{{ route('pdfFichaGlicemia', $id) }}" target="_blanck" class="btn btn-secondary px-3">
                                Generar PDF
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-12 mb-3">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($glicemia as $gli)
                                <tr>
                                    <td>{{ $gli['Fecha_Glicemia'] }}</td>
                                    <td>{{ $gli['Hora_Pre'] }}</td>
                                    <td>
                                        @if ( $gli['Pre'] == "true" )
                                    ...
                                    <th>
                                        <a href="{{ route('paciente.glicemia.leer', [$id, $gli['Id_Glicemia']]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#borrar-{{ $gli['Id_Glicemia'] }}" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="borrar-{{ $gli['Id_Glicemia'] }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <form action="{{ route('paciente.glicemia.borrar', [$id, $gli['Id_Glicemia']]) }}" method="post">
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span class="d-block"><b>Código: </b>{{ $gli['Id_Glicemia'] }}</span>
                                                </div>
