        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-3">
                ...
                <div class="col-12 mb-3">
                    ...
                    <form action="{{ route('paciente.glicemia.crear', $id) }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="horapre" name="horapre">
                                </div>
                            </div>
                                ...
                                <div class="form-group mt-3 ml-5">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" id="pre" name="pre">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="horapos" name="horapos">
                                </div>
                            </div>
